...
# Get your free API key: https://home.openweathermap.org/users/sign_up
# And read: https://openweathermap.org/appid
...
# Define a function to fetch wind direction periodically
def fetch_wind_data():
    global winddir
    global windspd
