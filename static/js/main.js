...
const ctxDew = document.getElementById("graphChartDew");
const ctxchill = document.getElementById("graphChartchill");
...
function destroyAllCharts() {
  ...
  graphChartDew.destroy();
  graphChartchill.destroy();
...
function drawGraph(data) {
  ...
  graphChartDew = new Chart(ctxDew, {
    type: "line",
    data: {
      datasets: [
        {
          ...
          data: data,
          parsing: {
            yAxisKey: items.dew.id,
          },
          borderColor: items.dew.color,
          borderWidth: 2,
          pointBackgroundColor: items.dew.color,
          pointRadius: 1,
        },
      ],
    },
    options: {
      ...
      animation: {
        onComplete: function () {
          ctxDew.classList.remove("loading-spinner");
        },
      },
    },
  });

  graphChartchill = new Chart(ctxchill, {
    type: "line",
    data: {
      datasets: [
        {
          label: items.chill.id,
          data: data,
          parsing: {
            yAxisKey: items.chill.id,
          },
          borderColor: items.chill.color,
          borderWidth: 2,
          pointBackgroundColor: items.chill.color,
          pointRadius: 1,
        },
      ],
    },
    options: {
      ...
      animation: {
        onComplete: function () {
          ctxchill.classList.remove("loading-spinner");
        },
      },
    },
  });
